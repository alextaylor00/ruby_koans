...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_character_classes_can_include_ranges
    ...
    assert_equal "42", "the number is 42"[/[2-4]+/]
  end
  ...
  def test_a_character_class_can_be_negated
    ...
    assert_equal "is the number ", "is the number 42 or not?"[/[^\d]+/]
  end
  ...
  def test_parentheses_group_contents
    ...
    assert_equal "hahaha", "ahhahaha"[/hahaha/]
  end
  ...
  def test_variables_can_also_be_used_to_access_captures
    ...
    # these are variables generated automagically by ruby after
    # a successful match. they're reset to nil after an unsuccessful match.
    # the variable is current scope only.
  end
