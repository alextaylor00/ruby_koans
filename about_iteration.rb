...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Like "each", but allows an argument to be passed in which is returned by the block.
    # http://ruby-doc.org/core-2.2.0/Enumerable.html#method-i-inject
  end
  ...
  # A: I'm guessing because the second style would leave the file open
